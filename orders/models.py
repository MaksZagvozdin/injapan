...
class Order(models.Model):
    user = models.ForeignKey(User,on_delete='', blank=True, null=True, default=None)
...
class ProductInOrder(models.Model):
    order = models.ForeignKey(Order,on_delete='', blank=True, null=True, default=None)
    product = models.ForeignKey(Product,on_delete='', blank=True, null=True, default=None)
